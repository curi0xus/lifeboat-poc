  ...
  return (
    ...
    >
      <div className=" flex min-h-screen place-items-center items-center justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div
          className="fixed inset-0 bg-gray-500 opacity-100 transition-opacity"
        ...
        <span
          ...
          aria-hidden="true"
        ></span>
        <div className="relative inline-block min-h-[70vh] w-11/12 translate-y-0 overflow-auto rounded-lg bg-white text-left align-bottom opacity-100 shadow-xl transition-all sm:w-4/5 sm:scale-100 sm:align-middle md:w-4/5 xl:w-2/3 2xl:w-2/3">
