    ...
    contentType === 0 && (
      <>
        ...
        <button
          ...
          className="ml-1 mt-5 flex w-4/5 flex-row items-center justify-center rounded-full px-4 py-1 text-lg transition disabled:cursor-not-allowed disabled:bg-gray-400 disabled:text-gray-700"
        >
          Sign Up
        </button>
      </>
