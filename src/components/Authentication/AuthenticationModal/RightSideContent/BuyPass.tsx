      ...
      <div className="flex w-10/12 flex-col space-y-3 text-center text-white">
        ...
        <div>
          ...
          <button
            ...
            className="ml-1 mt-1 flex w-full flex-row items-center justify-center rounded-full px-4 py-1 text-lg text-white transition disabled:cursor-not-allowed disabled:bg-gray-400 disabled:text-gray-700"
          >
            View Genesis Passes
          </button>
        </div>
        <div>
          <span className="text-sm text-gray-100">Just access Lifeboat.</span>
          <button
            onClick={viewLifeboatClickHandler}
            className="ml-1 mt-1 flex w-full flex-row items-center justify-center rounded-full border bg-white px-4 py-2 text-lg transition disabled:cursor-not-allowed disabled:bg-gray-400 disabled:text-gray-700"
          >
